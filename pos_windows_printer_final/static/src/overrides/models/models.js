...
patch(PosStore.prototype, {
    async setup() {
        ...
        if (this.config && this.config.use_pricelist === undefined) {
    ...
    async processServerData(loadedData) {
        if (loadedData && loadedData["pos.config"]) {
        ...
        if (this.config) {
            ...
            if (this.config.raw && this.config.raw.use_pricelist === undefined) {
    ...
    afterProcessServerData() {
        ...
        return super.afterProcessServerData(...arguments).then(function () {
            ...
            if (self.config) {
                if (self.config.use_pricelist === undefined) {
                    self.config.use_pricelist = false;
                }
