...
class HrPayslip(models.Model):
    ...
    # Some older views/actions may still reference these names (e.g. lateness_hours).
    # We keep them as stored aliases to avoid Owl view crashes.
    ...
    lateness_hours = fields.Float(string="Lateness (h) [Legacy]", digits=(16, 2), readonly=True, store=True)
    ot_hours_total = fields.Float(string="Overtime (h) [Legacy]", digits=(16, 2), readonly=True, store=True)
    ot_bank_hours = fields.Float(string="OT Bank (h) [Legacy]", digits=(16, 2), readonly=True, store=True)
    lateness_remaining = fields.Float(string="Remaining (h) [Legacy]", digits=(16, 2), readonly=True, store=True)
