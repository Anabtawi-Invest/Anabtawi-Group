...
class PosSession(models.Model):
    ...
    def _create_non_reconciliable_move_lines(self, data):
        ...
        - Aggregator campaign contribution is debited to aggregator receivable.
        - Company share is debited to the configured discount expense account.
        - The total tax-exclusive discount offset is credited to a dedicated
          Campaign Discount Recovery account, not to the normal Sales account.
        ...
        for line in lines:
            ...
            if has_discount and not aggregator.discount_recovery_account_id:
                raise UserError(_(
                    "Configure campaign discount recovery account on aggregator %s before closing the session.",
                    aggregator.display_name,
                ))
            ...
            if has_discount:
                discount_recovery_credits[aggregator.discount_recovery_account_id] += (
