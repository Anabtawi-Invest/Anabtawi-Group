...
class PosOrderLine(models.Model):
    ...
    def _check_online_amount_integrity(self):
        for line in self:
            ...
            commission_base_amount = abs(
                line.price_subtotal if line.commission_base == "before_tax" else line.price_subtotal_incl
            )
            expected_commission = currency.round(
                commission_base_amount * line.aggregator_commission_percent / 100.0
            )
