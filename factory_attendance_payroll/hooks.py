...
def post_init_hook(env):
    ...
    emp1 = env.ref('factory_attendance_payroll.factory_test_1_employee', raise_if_not_found=False)
    if not emp1:
    ...
    emp2 = env.ref('factory_attendance_payroll.factory_test_2_employee', raise_if_not_found=False)
    if not emp2:
