...
class AiReportingThirdPartyAiProvider(models.AbstractModel):
    ...
    def get_status(self):
        ...
        if provider == "openai":
            ...
            model = self._param("ai_reporting.openai_model", "gpt-5.6-terra")
            status.update({
                "available": True,
    ...
    def _call_openai(self, system_prompt, prompt, json_schema=None):
        ...
        payload = {
            "model": status.get("model") or "gpt-5.6-terra",
            "input": [
    ...
    def _report_system_prompt(self):
        return _(
            ...
            "calculated_measures, report_type, visualization_type, chart_type, and limit. "
    ...
    def _report_schema(self):
        definition = {
            ...
            "properties": {
                ...
                "visualization_type": {"type": "string", "enum": ["table", "chart", "pivot"]},
                "chart_type": {"type": ["string", "null"], "enum": ["bar", "line", "pie", None]},
