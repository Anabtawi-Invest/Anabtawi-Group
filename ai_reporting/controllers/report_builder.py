...
class AiReportingReportBuilderController(http.Controller):
    ...
    @http.route("/ai_reporting/report_builder/create", type="jsonrpc", auth="user")
    ...
    @http.route("/ai_reporting/report_builder/adjust", type="jsonrpc", auth="user")
    ...
    @http.route("/ai_reporting/report_builder/confirm", type="jsonrpc", auth="user")
