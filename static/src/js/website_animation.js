...
// ==========================================================================
// Anabtawi Sweets - Scroll-Driven Video Scrubbing Widget
// Uses canvas frame-by-frame scrubbing tied to scroll position
// ==========================================================================
publicWidget.registry.AnabtawiScrollVideo = publicWidget.Widget.extend({
    ...
    _preloadImages: function () {
        ...
        for (let i = 1; i <= this.totalFrames; i++) {
            ...
            // Path inside Odoo environment - uses module name for correct URL routing
...
// ==========================================================================
// Anabtawi Sweets - General Theme Animations Widget
// Handles scroll-fade-in and general page animations
// ==========================================================================
publicWidget.registry.AnabtawiThemeAnimations = publicWidget.Widget.extend({
    selector: 'body',

    start: function () {
        this._super.apply(this, arguments);
        this._initScrollAnimations();
        console.log("Anabtawi Sweets Theme loaded successfully.");
    },
