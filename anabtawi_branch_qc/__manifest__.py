# -*- coding: utf-8 -*-
{
    "name": "Branch Quality Control",
    "version": "19.0.1.0.0",
    "category": "Quality",
    "author": "Anabtawi",
    "summary": "Branch site-audit checklists, scoring, grading, corrective actions, ranking & dashboard.",
    "description": """
Branch Quality Control
======================
Periodic branch site-audit system for retail branches:

* Branch directory (master data)
...
* Branch ranking, factor performance, priority branches, historical trends
* Executive dashboard and printable PDF inspection report
* Role-based security (Inspector / Branch Manager / Quality Manager /
  Administrator / Management Viewer) with branch & company scoping
...
""",
    # Extends the standard Odoo Quality app: our Branch Quality Control tab is
    ...
    "depends": ["quality", "mail", "web", "base_setup"],
    "data": [
