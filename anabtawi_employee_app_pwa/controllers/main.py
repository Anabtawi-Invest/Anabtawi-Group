...
class AnabtawiEmployeeAppPWA(http.Controller):
    ...
    @http.route(["/employee-portal", "/employee-portal/"], type="http", auth="public", website=False)
    ...
    def employee_manifest(self, **kwargs):
        ...
        return request.make_json_response(manifest, headers=[("Cache-Control", "no-cache")])
