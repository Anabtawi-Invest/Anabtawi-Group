...
class OnlineDiscountCampaign(models.Model):
    ...
    def action_ecommerce_approve(self):
        if not self.env.user.has_group("anabtawi_online_campaigns.group_online_campaign_ecommerce_manager"):
    ...
    def action_finance_approve(self):
        if not self.env.user.has_group("anabtawi_online_campaigns.group_online_campaign_finance_manager"):
    ...
    def action_reject(self):
        if not self.env.user.has_group("anabtawi_online_campaigns.group_online_campaign_approver"):
    ...
    def compute_discount_amount(self, gross_amount, quantity=1.0):
        ...
        if cap and self.cap_application == "per_line":
