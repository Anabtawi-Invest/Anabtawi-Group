...
class AnabtawiMobileAPI(http.Controller):
    ...
    def employee_profile(self, **kwargs):
        ...
        # Employee App OTP is the rotating employee password from the
        # Anabtawi main employee_request module:
        #   hr.employee.employee_password
        #   hr.employee.employee_password_generated_at
        otp_number = ""
        otp_generated_at = False
        if "employee_password" in employee._fields:
            otp_number = str(employee.employee_password or "")
        if "employee_password_generated_at" in employee._fields:
            otp_generated_at = employee.employee_password_generated_at
        ...
        return _json({
            ...
            "otp_generated_at": fields.Datetime.to_string(otp_generated_at) if otp_generated_at else "",
