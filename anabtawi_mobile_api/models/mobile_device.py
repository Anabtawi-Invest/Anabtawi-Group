    ...
    def register_or_refresh_login(self, user, device_uid_clean, device_name=None, ip_address=None, platform=None, manufacturer=None, model_name=None, app_version=None):
        ...
        if inactive_device:
            vals = {
                ...
                "platform": platform or inactive_device.platform,
                "manufacturer": manufacturer or inactive_device.manufacturer,
                "model_name": model_name or inactive_device.model_name,
                "app_version": app_version or inactive_device.app_version,
                "active": True,
            }
        ...
        self_sudo.create({
            ...
            "manufacturer": manufacturer or False,
...
class HrEmployee(models.Model):
    ...
    employee_app_platform = fields.Char(
        string="Platform",
        compute="_compute_employee_app_active_device",
    )
    employee_app_manufacturer = fields.Char(
        string="Manufacturer",
        compute="_compute_employee_app_active_device",
    )
    employee_app_model_name = fields.Char(
        string="Model",
        compute="_compute_employee_app_active_device",
    )
    employee_app_version = fields.Char(
        string="App Version",
        compute="_compute_employee_app_active_device",
    )
    ...
    def _compute_employee_app_active_device(self):
        ...
        for employee in self:
            ...
            employee.employee_app_platform = device.platform or False
            employee.employee_app_manufacturer = device.manufacturer or False
            employee.employee_app_model_name = device.model_name or False
            employee.employee_app_version = device.app_version or False
